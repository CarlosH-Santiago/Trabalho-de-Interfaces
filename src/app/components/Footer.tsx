...
export function Footer({ isMinimal = false }: { isMinimal?: boolean }) {
  if (isMinimal) {
    return (
      <footer className="bg-black text-foreground py-12">
        <div className="container mx-auto px-6 text-center">
          <h3 className="text-2xl tracking-[0.3em]">ATELIER</h3>
        </div>
      </footer>
    );
  }
  ...
  return (
    <footer className="bg-black text-foreground py-16 lg:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Elegância atemporal e design consciente para quem valoriza a
